 ...
 */
 ...
 $this->resources = array(
	...
	"win_condition" => clienttranslate('WIN CONDITIONS:<br>* The player with the 2 stones wins.<br>* If 2 players have 1 stone each all players compare points.<br>* If only one stone was found it does not score. <br>* If no stone was found all players loose!'),
	"end_condition" => clienttranslate('The game ends on following conditions : <br>* 5 decks are depleted <br>* 4 decks are depleted and no stone was found.<br>* 2 Stones are found')
);
